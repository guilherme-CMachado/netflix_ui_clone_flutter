...
import 'package:netflixui/widgets/bot%C3%A3o_detalhes.dart';
...
class _Body extends StatefulWidget {
  ...
  const _Body(
      {Key key, this.video, this.cor, this.corClassificacao, this.episodios})
      : super(key: key);
